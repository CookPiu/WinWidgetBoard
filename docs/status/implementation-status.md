...
- UI 评审固定条件：浅色主题、`3200×2000 @ 165 Hz`、200% DPI、中文、CoreBroker 断开占位数据、6 张卡片，基线提交 `4e205a4`。Before：所有卡片共用左下角支点和固定欧拉旋转，视觉上均为左下向右上翻折；After：轴线按胶囊中心到卡片目标中心放射，铰点落在各卡片朝向胶囊的边缘；Why：让折页方向服从真实空间关系，并在响应式布局下自动保持逐卡片差异；
- Release UnitTests：392/392；
